 ...
 * 处理tagalias相关的逻辑
 * */
public class JpushAliasOperatorHelper {
    ...
    private static JpushAliasOperatorHelper mInstance;
    private JpushAliasOperatorHelper(){
    }
    public static JpushAliasOperatorHelper getInstance(){
        if(mInstance == null){
            synchronized (JpushAliasOperatorHelper.class){
                if(mInstance == null){
                    mInstance = new JpushAliasOperatorHelper();
                }
            }
        }
        return mInstance;
